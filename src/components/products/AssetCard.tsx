          ...
          {checkIsImageAsset(asset) ? (
            ...
            <div className="text-center p-3 flex flex-col items-center justify-center h-full">
              ...
              <p className="text-xs text-muted-foreground mt-1 font-medium">
                {getFileType(asset)?.toUpperCase() || 'UNKNOWN'}
              </p>
        ...
        <div className="flex items-start justify-between gap-1">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1">
              {getAssetIcon(asset.type || 'unknown')}
              <h3 className="text-xs font-medium truncate">{asset.name || 'Unnamed'}</h3>
            </div>
              ...
              {isEditingTags ? (
                <div className="mb-2">
                  ...
                  <div className="flex justify-end gap-1 mt-1">
                    ...
                    >
                      Save {tags.length > 0 ? `(${tags.length})` : ''}
                    </Button>
                  </div>
                </div>
              ) : (
            ...
            <div className="mt-1 text-xs text-muted-foreground space-y-1">
              <p className="text-[10px]">Size: {formatFileSize(asset.size)}</p>
