...
export const API_ENDPOINTS = {  auth: {    login: '/token/',    refresh: '/token/refresh/',    user: '/api/users/me/',    register: '/register/',    logout: '/auth/logout/'  },
    orgs: {    memberships: (orgId: string) => `/api/orgs/${orgId}/memberships/`,    roles: (orgId: string) => `/api/orgs/${orgId}/roles/`,    invitations: (orgId: string) => `/api/orgs/${orgId}/invitations/`  },
    products: {    list: '/api/products/',    create: '/api/products/',    update: (id: number) => `/api/products/${id}/`,    delete: (id: number) => `/api/products/${id}/`,    categories: '/api/categories/',    stats: '/api/products/stats/',    assets: (id: number) => `/api/products/${id}/assets/`,    asset: (productId: number, assetId: number) => `/api/products/${productId}/assets/${assetId}/`,    history: (id: number) => `/api/products/${id}/history/`,    checkSku: '/api/products/check-sku/'  },
    categories: {    list: '/api/categories/',    create: '/api/categories/',    update: (id: number) => `/api/categories/${id}/`,    delete: (id: number) => `/api/categories/${id}/`,    tree: '/api/categories/?as_tree=true',    move: '/api/categories/move/',    products: (id: number) => `/api/categories/${id}/products/`  },
    families: {    list: '/api/families/',    create: '/api/families/',    update: (id: number) => `/api/families/${id}/`,    delete: (id: number) => `/api/families/${id}/`,    attributeGroups: (id: number) => `/api/families/${id}/attribute-groups/`  },
    analytics: {    locales: '/api/analytics/locales/',    channels: '/api/analytics/channels/',    completeness: '/api/analytics/completeness/',    readiness: '/api/analytics/readiness/',    enrichmentVelocity: '/api/analytics/enrichment-velocity/',    localizationQuality: '/api/analytics/localization-quality/',    changeHistory: '/api/analytics/change-history/',    families: '/api/analytics/families/'  },
    dashboard: '/api/dashboard',  team: {    activity: '/api/dashboard/activity/',    history: '/api/team/history/'  },
    imports: {    create: '/api/imports/',    attributeGroups: '/api/attribute-groups/',    attributes: '/api/attributes-import/',    families: '/api/families-import/',    details: (id: number) => `/api/imports/${id}/`,    fieldSchema: '/api/imports/field-schema/',    fieldSchemaV2: '/api/imports/field-schema/?v=2',    attributeGroupsSchema: '/api/imports/attribute-groups-schema/',    attributesSchema: '/api/imports/attributes-schema/',    familiesSchema: '/api/imports/families-schema/',    familyAttributes: (familyCode: string) => `/api/families/${familyCode}/attributes/`  },
    reports: {    themes: '/api/reports/themes/'  }
}
