...
import organizationService from '@/domains/organization/services/organizationService';
...
export class AttributeService {
  ...
  static async fetchAttributeValues(
    ...
    try {
      ...
      const response = await axiosInstance.get(API_PATHS.products.attributes(productId), {
        headers: { 'Accept': 'application/json' },
        params
      });
  ...
  static async fetchAttributeGroups(
    ...
    try {
      ...
      const response = await axiosInstance.get(API_PATHS.products.groups(productId), {
        headers: { 'Accept': 'application/json' },
        params
      })
      return response.data
  ...
  static async createAttributeValue(
    ...
    try {
      ...
      const response = await axiosInstance.post(API_PATHS.products.attributes(productId), data, {
        headers: {
  ...
  static async updateAttributeValue(
    ...
    try {
      ...
      const response = await axiosInstance.patch(
        API_PATHS.products.attributeValue(productId, valueId), 
        data, 
        {
          headers: {
            'Accept': 'application/json',
  ...
  static async deleteAttributeValue(valueId: number, productId: number): Promise<void> {
    try {
      await axiosInstance.delete(API_PATHS.products.attributeValue(productId, valueId));
    } catch (error) {
  ...
  static async removeAttributeFromGroup(itemId: number, groupId: number): Promise<void> {
    try {
      await axiosInstance.delete(API_PATHS.attributeGroups.removeItem(groupId, itemId));
    } catch (error) {
