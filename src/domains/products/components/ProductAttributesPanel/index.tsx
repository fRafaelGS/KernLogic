...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/domains/core/components/ui/accordion'
...
import { Tooltip, TooltipContent, TooltipTrigger } from '@/domains/core/components/ui/tooltip'
import { PlusIcon, PencilIcon, Save, X, Trash2, Sparkles, Layers } from 'lucide-react'
import { useAttributes, useUpdateAttribute, useDeleteAttribute, useCreateAttribute, useAllAttributes, useAllAttributeGroups, useAttributeGroups, GROUPS_QUERY_KEY } from '@/domains/products/components/ProductAttributesPanel/api'
import type { Attribute, AttributeGroup } from '@/domains/products/components/ProductAttributesPanel/types'
import LocaleChannelSelector from '@/features/attributes/LocaleChannelSelector'
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogClose } from '@/domains/core/components/ui/dialog'
