 ...
 */
export const attributesToRecord = (attributes: ProductAttribute[] | Record<string, string> | undefined): Record<string, string> => {
 ...
 */
export const extractPrice = (product?: Product): number => {
