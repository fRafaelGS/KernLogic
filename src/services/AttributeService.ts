...
export class AttributeService {
  ...
  static async fetchAttributeValues(
    ...
    try {
      ...
      if (locale && locale !== 'default') params.locale = locale;
      if (channel && channel !== 'default') params.channel = channel;
  ...
  static async createAttributeValue(
    ...
    const data = {
      ...
      locale: normalizeLocaleOrChannel(locale),
      channel: normalizeLocaleOrChannel(channel)
    };
